...
# (project=scitex-audit, owner=ywatanabe1989, repo=scitex-audit,
...
TMPDIR="/tmp/publish-scitex_audit-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-audit dist/* uploaded to PyPI via manual OIDC trusted publishing"
