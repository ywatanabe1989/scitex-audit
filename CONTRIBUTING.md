# Contributing to scitex-audit

Thank you for your interest in contributing to scitex-audit. This guide covers
the process for reporting issues, suggesting features, and submitting code.
...
- Search [existing issues](https://github.com/ywatanabe1989/scitex-audit/issues)
  before opening a new one.
- Include a minimal reproducible example when reporting bugs.
- Specify your Python version, OS, and `scitex-audit` version.

## Development Setup

```bash
git clone git@github.com:ywatanabe1989/scitex-audit.git
cd scitex-audit
pip install -e ".[all]"
```
